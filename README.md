...
一个用于 AI agent 编写中文长篇小说的 [Anthropic Agent Skill](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview)。它本质上是一份提示词规范，约束 agent 在编写、修改、扩展中文小说时严格维护「全局大纲、人物设定、卷大纲、章节正文」四者之间的双向一致性，并强制每章字数落在 2500-4500 之间。

## 它做什么

- **强制目录结构**：根目录的 `全局大纲.md`、`人物设定/` 文件夹、`第N卷卷名/` 卷目录、卷下的 `卷大纲.md` 与各章节文件
...
- **字数检查**：每章写完用 `wc -m` 统计，少于 2500 扩写、超过 4500 精简或拆章
